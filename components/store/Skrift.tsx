    ...
    return (
        <div>
            ...
            >
                ...
                <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950/75 backdrop-blur-sm py-2 px-4 ring-1 ring-white/10 ">
                    <span>Get Skrift Suite</span>
